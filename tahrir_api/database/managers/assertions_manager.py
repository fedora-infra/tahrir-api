...
# Description: Assertion management module for Tahrir database
...
class AssertionManager(BaseManager):
    """Handles assertion-related database operations"""
    ...
    def get_assertions_by_email(self, person_email):
        ...
        person = self.persons.get_person(person_email=person_email)
        if person is None:
            return False
    ...
    def get_assertions_by_badge(self, badge_id):
        ...
        if self.badges.badge_exists(badge_id):
            return (
    ...
    def add_assertion(self, badge_id, person_email, issued_on, issued_for=None):
        ...
        if self.persons.person_exists(email=person_email) and self.badges.badge_exists(badge_id):
            badge = self.badges.get_badge(badge_id)
    ...
    def remove_assertion(self, badge_id, person_email):
        ...
        if not self.persons.person_exists(email=person_email):
            return False
